...
- Migration `crates/core/migrations/0012_ops_indexes.sql` — expand-only, CREATE INDEX
...
bash scripts/check-migration-safety.sh                     # 0012 expand-only gate
...
- [x] Migration `0012_ops_indexes.sql` (expand-only, indexes only; safety gate green)
